...
#    And I wait for '2' seconds
  ...
  Scenario: Validate the Service listing section
    ...
    And The 'Service_Card1_Title' element has following CSS properties
      | font-size      | 22px                        |
      | line-height    | 36px                        |
      | font-family    | Inter, "Inter Fallback"     |
      | font-weight    | 400                         |

    And 'Service_Card1_CTA_Text' is visible
    And The 'Service_Card1_CTA_Text' element has following CSS properties
      | font-size      | 12px                        |
      | line-height    | 14px                        |
      | font-family    | Inter, "Inter Fallback"     |
      | font-weight    | 500                         |
    ...
    And The 'Service_Card1_Description' element has following CSS properties
      | font-size      | 14px                        |
      | line-height    | 24px                        |
      | font-family    | Inter, "Inter Fallback"     |
      | letter-spacing | 0.2px                      |
